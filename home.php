	...
	<div class="content">
			...
			<div class="rt_content">
				...
				<ul>
						...
						<font size="12" face="italic" color="black"><b>Home Workout Routine  </b></font><br></br>
						<font size="3" face="italic" color="blue" align="center"><b> 
						<?php
						echo ' ',str_repeat("&nbsp;", 40);
						echo '<font size="5" face="italic" color="blue" align="center"><b> BURPEES </b></font>',"<br>",str_repeat("&nbsp;", 40);
						echo '<font size="5" face="italic" color="blue" align="center"><b> ALTERNATING FRONT KICKS</b></font>',"<br>",str_repeat("&nbsp;", 40);
						echo '<font size="5" face="italic" color="blue" align="center"><b> ALTERNATING CRESCENT LUNGE</b></font>',"<br>",str_repeat("&nbsp;", 40);
						echo '<font size="5" face="italic" color="blue" align="center"><b> PUSH UPS</b></font>',"<br>",str_repeat("&nbsp;", 40);
						echo '<font size="5" face="italic" color="blue" align="center"><b> MOUNTAIN CLIMBERS</b></font>',"<br>",str_repeat("&nbsp;", 40);
						echo '<font size="5" face="italic" color="blue" align="center"><b> 30 sec Each | 3 Rounds | 30-60 sec Rest b/w rounds</b></font>',"<br>",str_repeat("&nbsp;", 40);
						?>
						<iframe allowfullscreen="" frameborder="0" height="315" src="https://www.youtube.com/embed/rGRs2OsfwQg?&autoplay=1" width="681" ></iframe>
